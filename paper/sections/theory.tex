...
This section establishes the asymptotic properties of the cross-fitted
neural network estimator following \citet{farrell2021deep}. The key result
is that influence function corrections yield $\sqrt{n}$-consistent and
asymptotically normal estimators for the average treatment effect.
...
estimator with $K \geq 2$ folds satisfies:
\begin{equation}
...
the ATE under model~\eqref{eq:structural}. Thus, the cross-fitted estimator
is \textit{asymptotically efficient}.

%------------------------------------------------------------------------------
\subsection{Proof Sketch}
%------------------------------------------------------------------------------

The proof follows \citet{farrell2021deep}.
